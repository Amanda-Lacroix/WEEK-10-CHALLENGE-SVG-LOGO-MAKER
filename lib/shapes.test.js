...
test('This will test if the user input matches the output', () => {
    ...
    const results = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
...
// const result = generateLogo (answers);
// The expected result based on the answers given above.
